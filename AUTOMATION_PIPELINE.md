...
The `apps_gallery` repository (hosted at `XueshiQiao.github.io`) serves as a central hub for the following applications:
- **PastePaw**
- **Netstat Cat**
- **HyperCapslock**
- **Notifier**
...
- **Location**: Must be stored as an Action Secret in each participating app repository (currently `PastePaw`, `netstat-cat`, `HyperCapslock`, `Notifier`, and `AnyDrag`).
