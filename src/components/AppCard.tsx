  ...
  return (
    <Link to={`/app/${app.slug}`} className="block h-full group outline-none">
      <div className="glass-card rounded-2xl p-6 h-full flex flex-col relative overflow-hidden transition-all duration-500">
        ...
        <p className="text-slate-300 text-sm mb-6 flex-1 leading-relaxed relative z-10">{app.tagline}</p>
        ...
        {app.brewCommand && (
          <div className="mb-6 relative z-10">
            <div className="text-[10px] text-slate-500 mb-1.5 font-bold uppercase tracking-widest">Install via Homebrew</div>
            <div 
